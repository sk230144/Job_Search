...
import { fetchLoggedInUserOrderAsync, selectUserInfo, selectUserOrders, updateUserAsync } from '../userSlice.js';
    ...
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          {user.role ==='admin' && <h3 className="text-xl text-center my-5 font-bold tracking-tight text-red-900">
            Role : {user.role}
          </h3>}
        </div>
