...
export default function ProductList() {
  ...
  const filters = [
    {
      id: 'brand',
      name: 'Choose Language(Uncheck for selecting next language)',
      options: brands,
    },
    {
      id: 'category',
              ...
              <section aria-labelledby="products-heading" className="pb-24 pt-6">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <div className="lg:col-span-3">
                    ...
                    <ProductGrid onClick={handleCart} products={products} status={status} handleCart={handleCart}></ProductGrid>
              ...
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                <div key={product.id} className="group relative border-solid border-2 p-2 border-gray-200">
                  ...
                  <div className="mt-4 flex justify-between">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">Type:{product.price}</p>
                      <p className="text-sm font-medium text-gray-400">Location:{product.discountPercentage}</p>
